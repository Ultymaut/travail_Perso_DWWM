...
<body class="bg">
    ...
    <div class="form border color1">
        ...
        <form action="../controller/execute_telechargement.php" method="get">
            <input class="btn2" type="submit" value="DL">
        </form>
    </div>
    ...
    <div class="grille">
        ...
        <div class="relative table3">
            ...
            <table>
                <!-- Place_9 et 10 -->
                <tr class="color">
                    <td>Place_10 <br><?php echo $_SESSION['Place_9']; ?><br></td>
                    <td>Place_9 <br><?php echo $_SESSION['Place_10']; ?><br></td>
                </tr>
                <!-- Place_11 et 12 -->
                <tr class="color">
