...
<div class="d-flex justify-content-center mb-3">
        <div class="" style="width:50em">
            <form class="font2 mt-3 d-grid gap-4 col-4 mx-auto" action="../Control/execute_Delete.php" method="Post">
                <div class="form-floating " style="width : 32em">
                    <input type="id" name="id" class="form-control" id="floatingInput" placeholder="ID">
                    <label for="floatingInput">ID</label>
                    </div>
                    <input type="submit" style="width : 32em" name="submit" class="btn btn-outline-warning " value="Delete">
                    <a style="width : 32em" href="../View/index.php" class="btn btn-outline-danger ">Cancel</a>
                <a style="width : 32em" href="../Control/execute_RefreshDelete.php" class="btn btn-outline-info ">Refresh</a>
            </form>
        </div>
    </div>
