...
<div class="d-flex justify-content-center">
    <div class="" style="width:50em">
        <form class="font2 mt-5 d-grid gap-4 col-4 mx-auto" action="../Control/execute_Update.php" method="Post">
            ...
            <div class="form-floating" style="width : 32em">
                <input type="prenom" name="prenom" class="form-control" id="floatingPassword" placeholder="Prénom">
            ...
            <input type="submit" style="width : 32em" name="submit" class="btn btn-outline-success " value="Update">
            <a style="width : 32em" href="../View/index.php" class="btn btn-outline-danger mt-2">Cancel</a>
                <a style="width : 32em" href="../Control/execute_RefreshUpdate.php" class="btn btn-outline-info mt-2">Refresh</a>
        </form>
