...
<body>
    <h1 class="bg-dark opacity-75"> <a href="../View/index.html"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" class="d-flex justifiy-content-start me-5" file="red">
                <path d="M11.03 2.59a1.501 1.501 0 0 1 1.94 0l7.5 6.363a1.5 1.5 0 0 1 .53 1.144V19.5a1.5 1.5 0 0 1-1.5 1.5h-5.75a.75.75 0 0 1-.75-.75V14h-2v6.25a.75.75 0 0 1-.75.75H4.5A1.5 1.5 0 0 1 3 19.5v-9.403c0-.44.194-.859.53-1.144ZM12 3.734l-7.5 6.363V19.5h5v-6.25a.75.75 0 0 1 .75-.75h3.5a.75.75 0 0 1 .75.75v6.25h5v-9.403Z"></path>
            </svg></a>Tu est sur la page update</h1>
</body>
<?php session_start(); ?>
    ...
    <table class="h-100">
        ...
        <tbody class="">
            ...
            <div class="d-flex justify-content-center mb-3">
                <form role="form" method="POST" action="../Controller/exec_Update.php">
                    <label class="text-white me-2">ID</label>
                    <input type="ID" class="me-5" name="ID">
                    <label class="text-white me-2">NOM</label>
                    <input type="NOM" class="me-5" name="NOM">
                    <label class="text-white me-2">PRENOM</label>
            ...
            <div class="d-flex justify-content-center justify-content-around mb-3">
                ...
                <a href="../View/Update.php" class="btn btn-outline-danger">Annuler </a>
                </form>
            </div>
