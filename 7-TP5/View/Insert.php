...
<body>
    ...
    <div class="d-flex justify-content-center">
        <form enctype="multipart/form-data" action="../Controller/exec_Insert.php" method="post" style="width: 50%;">
            <div class="mb-3">
                <label for="formFile" class="form-label"></label>
                <input class="form-control" type="file" id="formFile" name="file">
            </div>
            <div class="d-flex justify-content-center mt-5">
                <input class=" btn btn-success" name="submit" type="submit" value="valider" style="height: 20%; width: 20%;"/>
            </div>
        </form>
    </div>
